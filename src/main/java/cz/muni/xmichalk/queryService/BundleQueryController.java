...
public class BundleQueryController {
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Query Params", required = true, content = @Content(schema = @Schema(implementation = QueryParams.class), examples = {
      @ExampleObject(name = "Get subgraph of Derivation/Specialization relations going backward from the start node", value = """
          {
            "bundleId": {
          ...
          """),
      @ExampleObject(name = "Find a subgraph of Usage/Generation/Specialization relations going forward from the start node, Specialization going both directions", value = """
          {
            "bundleId": {
              "nameSpaceUri": "http://prov-storage-2:8000/api/v1/organizations/ORG2/documents/",
          ...
          """), @ExampleObject(name = "Get actions associated with Jane Smith", value = """
          {
            "bundleId": {
          ...
          """), @ExampleObject(name = "Get main activity id", value = """
          {
            "bundleId": {
          ...
          """), @ExampleObject(name = "Get backward connectors that the start connector was derived from", value = """
          {
            "bundleId": {
              "nameSpaceUri": "http://prov-storage-3:8000/api/v1/organizations/ORG3/documents/",
              "localPart": "SpeciesIdentificationBundle_V0"
          ...
          """), @ExampleObject(name = "Test whether bundle has exactly one main activity", value = """
          {
            "bundleId": {
              "nameSpaceUri": "http://prov-storage-2:8000/api/v1/organizations/ORG2/documents/",
              "localPart": "ProcessingBundle_V0"
          ...
          """), @ExampleObject(name = "Get bundle id of the newest version of this bundle", value = """
          {
            "bundleId": {
              "nameSpaceUri": "http://prov-storage-1:8000/api/v1/organizations/ORG1/documents/",
  ...
  public ResponseEntity<?> bundleQuery(@RequestBody QueryParams queryParams, HttpServletRequest request) {
  ...
  private static List<String> getMissingParams(QueryParams params) {
    ...
    if (params.bundleId == null)
      missing.add("bundleId");
    if (params.querySpecification == null)
      missing.add("querySpecification");
