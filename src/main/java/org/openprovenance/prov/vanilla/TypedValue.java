...
public class TypedValue implements org.openprovenance.prov.model.TypedValue, Equals, ToString, HashCode {
  ...
  public static Object castToStringOrLangStringOrQualifiedName(Object value, QualifiedName type) {
    ...
    return (value instanceof org.openprovenance.prov.model.LangString)
        ...
        : ((value instanceof org.openprovenance.prov.model.QualifiedName)
            ? value
            : ((QualifiedName_PROV_LANG_STRING.equals(type))
  ...
  public QualifiedName getQualifiedName(Attribute.AttributeKind kind) {
    switch (kind) {
      case PROV_TYPE:
        return QualifiedName_PROV_TYPE;
      case PROV_LABEL:
        return QualifiedName_PROV_LABEL;
      case PROV_VALUE:
        return QualifiedName_PROV_VALUE;
      case PROV_LOCATION:
        return QualifiedName_PROV_LOCATION;
      case PROV_ROLE:
        return QualifiedName_PROV_ROLE;
      case OTHER:
      default:
        return null;
    }
  ...
  public Attribute.AttributeKind getAttributeKind(QualifiedName q) {
    if (q.equals(QualifiedName_PROV_TYPE))
      return Attribute.AttributeKind.PROV_TYPE;
    if (q.equals(QualifiedName_PROV_LABEL))
      return Attribute.AttributeKind.PROV_LABEL;
    if (q.equals(QualifiedName_PROV_VALUE))
      return Attribute.AttributeKind.PROV_VALUE;
    if (q.equals(QualifiedName_PROV_LOCATION))
      return Attribute.AttributeKind.PROV_LOCATION;
    if (q.equals(QualifiedName_PROV_ROLE))
      return Attribute.AttributeKind.PROV_ROLE;
