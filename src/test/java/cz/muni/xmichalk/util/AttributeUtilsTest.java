...
public class AttributeUtilsTest {
  ...
  public void testGetAttributeValue_location() {
    ...
    assert loc.getValue() instanceof String;
    String langString = (String) loc.getValue();
    assert langString.equals("marineregions:3293");
  ...
  public void testHasAttributeTargetValue_provType_true() {
    ...
    QualifiedName attributeName = new org.openprovenance.prov.vanilla.QualifiedName(NameSpaceConstants.PROV_URI, "type",
        "prov");
  ...
  public void testIsTargetValue_provType_true() {
    ...
    boolean isTargetValue = AttributeUtils.isTargetValue(value, QualifiedName.class,
  ...
  public void testIsTargetValue_provTypeList_false() {
    ...
    boolean isTargetValue = AttributeUtils.isTargetValue(List.of(value), QualifiedName.class,
        qn -> qn.getUri().equals("otherUri"));
